...
@class KKBookLeftSidebar;

@protocol KKBookLeftSidebarDelegate <NSObject>
@optional
- (void)sidebar:(KKBookLeftSidebar *)sidebar willShowOnScreenAnimated:(BOOL)animatedYesOrNo;
- (void)sidebar:(KKBookLeftSidebar *)sidebar didShowOnScreenAnimated:(BOOL)animatedYesOrNo;
- (void)sidebar:(KKBookLeftSidebar *)sidebar willDismissFromScreenAnimated:(BOOL)animatedYesOrNo;
- (void)sidebar:(KKBookLeftSidebar *)sidebar didDismissFromScreenAnimated:(BOOL)animatedYesOrNo;
...
@interface KKBookLeftSidebar : UIViewController
...
@property (nonatomic, weak) id <KKBookLeftSidebarDelegate> delegate;
